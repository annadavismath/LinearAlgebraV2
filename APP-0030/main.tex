...
When a chemical reaction\index{chemical reaction} takes place a number of molecules combine to produce new molecules. Hence, when hydrogen $\mbox{H}_2$ and oxygen $\mbox{O}_2$ molecules combine, the result is water H\textsubscript{2}O. We express this as
\begin{equation*}
