...
% \end{array}\right]
\end{align}
We stop at the row-echelon form of $A$ because its determinant is easy to compute by multiplying its diagonal entries (See Practice Problem \ref{prob:detoftrimat} of DET-M-0020).
...
\begin{problem}\label{prob:elemrowopsdet}
...
\begin{problem}\label{prob:elemmatdet}
