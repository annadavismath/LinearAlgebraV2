...
To use the interactive, define vectors $\vec{v}$, $\vec{w}$ and $\vec{u}$.  Use sliders to change the coefficients $k_1, k_2$ and $k_3$ of the linear combination.  RIGHT-CLICK and DRAG the left panel to rotate the image.
\begin{center} 
