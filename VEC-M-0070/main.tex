...
\input{../preamble.tex}
\author{Anna Davis \and Rosemarie Emanuele} \title{VEC-0070:  Orthogonal Projections} \license{CC-BY 4.0}
...
Find $\mbox{proj}_{\vec{d}}\vec{v}$.  Enter your answers in decimal form; round to the nearest tenth.
...
Find the projection of vector $\vec{v}$ onto line $l$. Enter your answers in decimal form; round to the nearest one hundredth.
...
Answer:
$$\begin{bmatrix}\answer{-3.65}\\\answer{0.73}\end{bmatrix}$$
\end{problem}
...
Find the equation of a circle centered at $(4, 2)$ if the line $y=\frac{3}{2}x+3$ is tangent to the circle.  Enter your answer as a fraction with the denominator of $13$.
