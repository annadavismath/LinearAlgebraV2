...
To follow the computation below, you need to recall that the imaginary unit $i$ is defined to by $i^2=-1$.  Please refer to \href{https://ximera.osu.edu/oerlinalg/LinearAlgebra/APX-0020/main}{Complex Numbers} for more information.
