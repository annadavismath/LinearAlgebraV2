...
% $$\begin{vmatrix}{\color{red}1}&{\color{red}0}\\{\color{blue}0}&{\color{blue}2}\end{vmatrix}=2\begin{vmatrix}{\color{red}1}&{\color{red}0}\\{\color{blue}0}&{\color{blue}1}\end{vmatrix}$$
% \begin{center}
% \begin{tikzpicture}[scale=1]
% \draw[thin,gray!40] (-1,-1) grid (3,3);
%   \draw[<->] (-1,0)--(3,0);
...
% If we shear the figure, the area is not affected. (Why?)
...
% The determinant also remains unchanged.
% $$\begin{vmatrix}{\color{red}1}&{\color{red}0}\\{\color{blue}k}&{\color{blue}1}\end{vmatrix}=1$$
...
\end{exploration}
A formal discussion of the concept of area is beyond the scope of this class, so we will not prove your conjecture in Exploration \ref{exp:LinTransAreaDet} for arbitrary figures.  We can, however, tackle the problem of how linear transformations affect areas of parallelograms.  This is the topic of our next example.
