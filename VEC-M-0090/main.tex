...
Geometrically, we can use Procedure \ref{pro:lincombgeo} of VEC-M-0040 to express any vector of $\RR^2$ as a linear combination of $\begin{bmatrix}2\\2\end{bmatrix}$ and  $\begin{bmatrix}-1\\0\end{bmatrix}$.  So, intuitively it makes sense that the two vectors span all of $\RR^2$.
