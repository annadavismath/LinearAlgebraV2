...
We immediately see that $\mbox{rank}(A)=3$, so $\mbox{dim}(\mbox{im}(T))=3$.  
...
This definition gives us the following relationship between the rank of a linear transformation $T$ and the rank of the standard matrix $A$ associated with it.
...
This definition gives us the following relationship between nullity of a linear transformation $T$ and the nullity of the standard matrix $A$ associated with it.
