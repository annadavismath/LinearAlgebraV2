...
\end{enumerate}
\end{theorem}
The proof of this theorem is relegated to \href{https://ximera.osu.edu/oerlinalg/LinearAlgebra/DET-0050/main}{Tedious Proofs Concerning Determinants}.  The following lemma is a useful consequence of Theorem \ref{th:elemrowopsanddet}.
