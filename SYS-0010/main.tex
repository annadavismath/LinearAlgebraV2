...
To obtain the solution to Exploration \ref{init:systwoeqs1} we utilized three \dfn{elementary row operations}.  These operations are:
\begin{itemize}
...
\end{itemize}
At each stage of the process, the system of equations looked different from the original system, but a quick check will convince you that all six systems have the same solution: $(-1, 2)$.  The six systems are said to be \dfn{equivalent}.  
