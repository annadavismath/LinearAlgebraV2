...
In general, any transformation that satisfies (\ref{eq:matrixTransProp1}) and (\ref{eq:matrixTransProp2}) is called a \dfn{linear transformation}.  As we have just found, all matrix transformations are linear.
