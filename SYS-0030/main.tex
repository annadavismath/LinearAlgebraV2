...
$$\left[\begin{array}{ccc|c}  2&1&1&3\\-1&0&1&2\\1&1&-2&0
 ...
 \begin{prompt}  Multiply the Row 1 by $\frac{1}{2}$.
%   $$\begin{array}{c}
%   \xrightarrow{\frac{1}{2}R_1}\\
% \\
% \\
...
$$ \left[\begin{array}{ccc|c}   \answer{1}&\answer{1/2}&\answer{1/2}&\answer{3/2}\\-1&0&1&2\\1&1&-2&0
 ...
 \begin{problem} 
 \begin{prompt} Add Row 1 to Row 2.
% $$\begin{array}{c}
% \\
%   \xrightarrow{R_2+R_1}\\
% \\
...
$$ \left[\begin{array}{ccc|c}  1&1/2&1/2&3/2\\\answer{0}&\answer{1/2}&\answer{3/2}&\answer{7/2}\\1&1&-2&0
 ...
 \end{prompt}
 \begin{problem}
 \begin{prompt} Subtract Row 1 from Row 3.
% \[\begin{array}{c}
%   \\
% \\
%  \xrightarrow{R_3-R_1}
...
$$ \left[\begin{array}{ccc|c}   1&1/2&1/2&3/2\\0&1/2&3/2&7/2\\\answer{0}&\answer{1/2}&\answer{-5/2}&\answer{-3/2}
 ...
 \end{prompt}
  \begin{problem}
  \begin{prompt} Multiply Row 2 by 2.
% \[\begin{array}{c}
% \\
%  \xrightarrow{2R_2}\\
% \\
...
\end{prompt}
 \begin{problem}
 \begin{prompt} Subtract $\frac{1}{2}$ of Row 2 from Row 3.
% \[\begin{array}{c}
% \\
% \\
%  \xrightarrow{R_3-\frac{1}{2}R_2}
...
1&1/2&1/2&3/2\\0&1&3&7\\\answer{0}&\answer{0}&\answer{-4}&\answer{-5}
 ...
 \end{prompt}
 \begin{problem}
 \begin{prompt} Multiply Row 3 by $-\frac{1}{4}$.
% \[\begin{array}{c}
%  \\
%  \\
...
$$\left[\begin{array}{ccc|c}    1&1/2&1/2&3/2\\0&1&3&7\\\answer{0}&\answer{0}&\answer{1}&\answer{5/4}
 ...
 \end{prompt}
 \begin{problem}
 \begin{prompt} Subtract 3 times Row 3 from Row 2.
% \[\begin{array}{c}
%  \\
...
1&1/2&1/2&3/2\\\answer{0}&\answer{1}&\answer{0}&\answer{13/4}\\0&0&1&5/4
 ...
 \end{prompt}
 \begin{problem}
 \begin{prompt} Subtract $\frac{1}{2}$ of Row 3 from Row 1.
...
\answer{1}&\answer{1/2}&\answer{0}&\answer{7/8}\\0&1&0&13/4\\0&0&1&5/4
 \end{array}\right]$$
  \end{prompt}
  \begin{problem}
 \begin{prompt} Subtract $\frac{1}{2}$ Row 2 from Row 1.
% \[\begin{array}{c}
