...
\begin{definition}
Equation (\ref{eqn:chareqn}) is called the \dfn{characteristic equation} of $A$.  The left-hand side of Equation (\ref{eqn:chareqn}) is called the \dfn{characteristic polynomial} of $A$.
\end{definition}
