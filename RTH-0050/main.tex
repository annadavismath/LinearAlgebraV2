...
There is a natural generalization to $\mathbb{C}^n$ of the dot product in $\RR^n$ called the \dfn{standard inner product}.  For more on inner products, see \href{}{Inner Product Spaces}.
