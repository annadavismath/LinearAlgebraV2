...
\end{example}
\begin{remark}
Recall that a square matrix whose reduced row-echelon form is the identity matrix is called \dfn{nonsingular}. (Definition \ref{def:nonsingularmatrix} of SYS-M-0030)
