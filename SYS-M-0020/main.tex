...
\begin{equation}\label{eq:originalsystem1}
...
\begin{array}{ccccccccc}
   ...
   0x& +&0y&+&z&+&0w&=&2\\
    ...
    \begin{equation}\label{eq:rrefnozeros}
    \begin{array}{ccccccccc}
      x & &&&&&&= &-1 \\
   & &y&&&&&=&-1\\
   & &&&z&&&=&2\\
...
\\
 ...
 The last augmented matrix corresponds to systems in (\ref{eq:rref1}) and (\ref{eq:rrefnozeros}), and we can easily see the solution.   
\end{exploration}
