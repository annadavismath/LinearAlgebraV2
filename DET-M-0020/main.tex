...
\author{Anna Davis \and Paul Zachlin \and Rosemarie Emanuele} \title{Definition of the Determinant: Expansion Along the First Column} \license{CC-BY 4.0}
...
\begin{initprob}\label{init:expansionfirstcol2}
Let
...
\section*{Column Expansion Definition of the Determinant}
...
\begin{definition}\label{def:toprowexpansion1}  Let $A=\begin{bmatrix}a_{ij}\end{bmatrix}$ be an $n\times n$ matrix.  Define the determinant of $A$ by
...
\begin{definition}\label{def:firstcolexpansion1}  Let $A=\begin{bmatrix}a_{ij}\end{bmatrix}$ be an $n\times n$ matrix.  Define the determinant of $A$ by
...
\section*{Proof of Definition Equivalence}
