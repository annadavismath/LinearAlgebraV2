...
A natural question is this: does every square matrix have eigenvalues and eigenvectors?  We will see in Module EIG-M-0020 that the answer to this question is ``yes", provided that we permit eigenvalues and entries of eigenvectors to be complex numbers.  The next example is one that requires complex numbers.
...
\begin{problem}Let $C=\begin{bmatrix} 2 & 1 & 1\\ 1 & 2 & 1\\ 1 & 1 & 2\end{bmatrix}$.  \begin{problem}
