...
%\begin{initprob}
%Consider $$S_1=\mbox{span}\left(\begin{bmatrix}2\\6\\3\end{bmatrix}\right)$$  
...
%Now consider 
%$$S_2=\mbox{span}\left(\begin{bmatrix}2\\6\\3\end{bmatrix}, \begin{bmatrix}4\\12\\6\end{bmatrix}\right)$$ 
