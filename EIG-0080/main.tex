...
\href{https://ximera.osu.edu/oerlinalg/LinearAlgebra/APX-0020/main}{Complex Numbers}, inequality \ref{eqn:pr3} follows from the Triangle Inequality (C12 of \ref{eqn:complex_number_properties}), and we arrive at inequality \ref{eqn:pr5} by replacing each $\vec{x}_j$ in inequality \ref{eqn:pr4} by $\vec{x}_k$.
