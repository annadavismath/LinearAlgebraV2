...
\begin{exploration}\label{init:vertstretch} Let us attempt to find a matrix $M$ of transformation $T$ that stretches an image vertically by a factor of 2, as shown in the figure below.  
...
\begin{hint}
    Use Problem \ref{prb:linesToLines}
\end{hint}
\end{problem}
