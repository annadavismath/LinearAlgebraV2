...
Show that any two rows of a matrix can be interchanged by using the other two elementary row operations.  (This shows that one of the elementary row operations is ``redundant" of the other two.)
